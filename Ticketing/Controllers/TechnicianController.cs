...
namespace Ticketing.Controllers
{
    ...
    public class TechnicianController : Controller
    {
        ...
        public async Task<IActionResult> Index(string SearchValue)
        {
            ...
            var tickets = await _unitofWork.TicketRepo.GetFilteredAndOrderedTicketsForTechnician(technicianId);
        ...
        public async Task<IActionResult> Edit([FromRoute] int id, TicketsViewModel TicketVM)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    // Assuming TicketVM contains properties for newStatus and comment
                    await _unitofWork.TicketRepo.UpdateStatusAndAddCommentAsync(TicketVM.Id, TicketVM.Status, TicketVM.Comment);
